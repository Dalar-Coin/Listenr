...
const EQ = () => {
  ...
  return (
    <div>
      <div className="grid grid-flow-col auto-cols-fr mx-5 mr-2 ml-8 -mt-122.5 mb-10 justify-center">
        <div className="border h-111.5 mr-0.5 hover:bg-indigo-100 hover:opacity-50 transition-all"></div>
        {rank.map((item) => (
          <button
            key={item.id}
